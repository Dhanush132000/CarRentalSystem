    ...
    <div class="card w-50 container my-5">
        <div class="card-body">
            ...
            <div class="text-center">
                <h3 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif"><?php echo $navname?> Login</h3>
            </div>
            <form method="get" action="../Action/customerAction.php">
                ...
                <div class="mb-5 mx-3">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="Password" required oninvalid="this.setCustomValidity('Password is required')" oninput="setCustomValidity('')">
                </div>
                <div class="mb-5 mx-3 ">
            ...
            <div class="mb-3 text-center">
                    ...
                    <a href="./register.php">SignUp from here</a><br>
                </div>
        </div>
    </div>
